	...
	const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
		...
		emailjs
			.send(
				...
				{
					from_name: form.name,
					to_name: "Amit Bishnoi",
					from_email: form.email,
					to_email: "amitbishnoi.brw@gmail.com",
				...
				>
					<label className="flex flex-col">
						...
						<input
							...
							className="bg-tertiary py-4 px-6 placeholder:text-secondary text-primary rounded-lg outline-none border-none font-medium"
						/>
					</label>
					<label className="flex flex-col">
					...
					<button
						type="submit"
						className="bg-tertiary py-3 px-8 outline-none w-fit text-primary font-bold shadow-md shadow-primary rounded-xl"
					>
